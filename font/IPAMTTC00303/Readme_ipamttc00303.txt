...
IPAフォント（IPA明朝/IPA P明朝 TrueTypeコレクションフォントファイル）  IPAMTTC00303.zip
|--はじめにお読みください   Readme_ipam00303.txt
|--IPAフォントライセンスv1.0   IPA_Font_License_Agreement_v1.0.txt
|--IPA明朝/IPA P明朝   ipam.ttc（ ipam.ttf/ipamp.ttf）


「IPAフォント」は、IPAの登録商標です。

=========================
IPA Font (IPAMincho/IPAPMincho)
-- Readme --
...
IPA Font (IPAMincho/IPAPMincho TrueType Collection font file)  IPAMTTC00303.zip
|--Readme   Readme_ipam00303.txt
|--IPA Font License Agreement v1.0   IPA_Font_License_Agreement_v1.0.txt
|--IPAMincho/IPAPMincho   ipam.ttc（ ipam.ttf/ipamp.ttf）
